...
function cargar_carousel() {
    $.ajax({
        ...
        if (jsonObjet.length > 0) {
            ...
            $("#contenido_carrousel_1").append("<h5 class='bor_texto'>"+jsonObjet[0].titulo_proyecto+"</h5><h4 class='bor_texto'>Lider: "+jsonObjet[0].nombre_completo+"</h4><p class='bor_texto'>"+jsonObjet[0].resumen+"</p>");
            $("#contenido_carrousel_3").append("<h5 class='bor_texto'>"+jsonObjet[1].titulo_proyecto+"</h5><h4 class='bor_texto'>Lider: "+jsonObjet[1].nombre_completo+"</h4><p class='bor_texto'>"+jsonObjet[1].resumen+"</p>");
            $("#contenido_carrousel_5").append("<h5 class='bor_texto'>"+jsonObjet[2].titulo_proyecto+"</h5><h4 class='bor_texto'>Lider: "+jsonObjet[2].nombre_completo+"</h4><p class='bor_texto'>"+jsonObjet[2].resumen+"</p>");
    ...
    $.ajax({
        ...
        if (jsonObjet.length > 0) {
            ...
            $("#contenido_carrousel_2").append("<h5 class='bor_texto'>"+jsonObjet[0].nombre_evento+"</h5><p class='bor_texto'>"+jsonObjet[0].descripcion+"</p>");
            $("#contenido_carrousel_4").append("<h5 class='bor_texto'>"+jsonObjet[1].nombre_evento+"</h5><p class='bor_texto'>"+jsonObjet[1].descripcion+"</p>");
