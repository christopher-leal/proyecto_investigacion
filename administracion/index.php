...
<body style="background: #f8f8f8">
    ...
    <ul class="nav nav-tabs sticky-top" id="myTab" role="tablist" style="background: #f0f0f0;">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item" ><a style="float:right" class="nav-link list-group-item-action" href='../includes/funciones/cerrar.php'>Salir</a></li>
    </ul>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 col-md-12">
                            <label for="in_apellido_matertno" class="font-weight-bold">in_apellido matertno</label>
                            <input type="text" id="in_apellido_matertno" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 col-md-12">
                            ...
                            <input type="text" id="in_link_congreso" class="form-control">
                        </div>
                    </div>
                </div>
                <!--pie del modal-->
                <div class="modal-footer">
                    <button id="btn_guardar_congreso" class="btn btn-md btn-outline-success">Guardad</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="registrar_anuncio">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <!--Cabecera del modal-->
                <div class="modal-footer">
                    <button id="btn_guardar_anuncio" class="btn btn-md btn-outline-success">Guardad</button>
                </div>
            </div>
        </div>
    </div>
